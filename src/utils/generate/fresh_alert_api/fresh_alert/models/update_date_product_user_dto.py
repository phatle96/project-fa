...
T = TypeVar("T", bound="UpdateDateProductUserDto")


@_attrs_define
class UpdateDateProductUserDto:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_date_product_user_dto = cls(
        ...
        update_date_product_user_dto.additional_properties = d
        return update_date_product_user_dto

...
if TYPE_CHECKING:
    from ..models.date_extract_response_dto import DateExtractResponseDto


T = TypeVar("T", bound="DateControllerExtractResponse200")


@_attrs_define
class DateControllerExtractResponse200:
    """
    Attributes:
        res (float):  Example: 1.
        ...
        data (Union[Unset, DateExtractResponseDto]):
    """
    ...
    data: Union[Unset, "DateExtractResponseDto"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = DateExtractResponseDto.from_dict(_data)

        date_controller_extract_response_200 = cls(
            res=res,
            error=error,
        ...
        date_controller_extract_response_200.additional_properties = d
        return date_controller_extract_response_200

...
T = TypeVar("T", bound="KeyPhraseControllerCreateResponse200")


@_attrs_define
class KeyPhraseControllerCreateResponse200:
    """
    Attributes:
        res (float):  Example: 1.
    ...
    data: Union[Unset, "KeyPhraseDto"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = KeyPhraseDto.from_dict(_data)

        key_phrase_controller_create_response_200 = cls(
            res=res,
            error=error,
        ...
        key_phrase_controller_create_response_200.additional_properties = d
        return key_phrase_controller_create_response_200

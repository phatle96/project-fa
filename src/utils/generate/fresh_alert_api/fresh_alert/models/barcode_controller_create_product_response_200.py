...
T = TypeVar("T", bound="BarcodeControllerCreateProductResponse200")


@_attrs_define
class BarcodeControllerCreateProductResponse200:
    """
    Attributes:
        res (float):  Example: 1.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        barcode_controller_create_product_response_200 = cls(
            res=res,
            error=error,
        ...
        barcode_controller_create_product_response_200.additional_properties = d
        return barcode_controller_create_product_response_200

...
T = TypeVar("T", bound="DateControllerUpdateResponse200")


@_attrs_define
class DateControllerUpdateResponse200:
    """
    Attributes:
        res (float):  Example: 1.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        date_controller_update_response_200 = cls(
            res=res,
            error=error,
        ...
        date_controller_update_response_200.additional_properties = d
        return date_controller_update_response_200

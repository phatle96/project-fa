...
T = TypeVar("T", bound="DateControllerCalculateQuantityResponse200")


@_attrs_define
class DateControllerCalculateQuantityResponse200:
    """
    Attributes:
        res (float):  Example: 1.
        ...
        data (Union[Unset, DateResponseModel]):
    """
    ...
    data: Union[Unset, "DateResponseModel"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = DateResponseModel.from_dict(_data)

        date_controller_calculate_quantity_response_200 = cls(
            res=res,
            error=error,
        ...
        date_controller_calculate_quantity_response_200.additional_properties = d
        return date_controller_calculate_quantity_response_200

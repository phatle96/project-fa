...
T = TypeVar("T", bound="ProductControllerFindAllByUserLookbackDaysResponse200")


@_attrs_define
class ProductControllerFindAllByUserLookbackDaysResponse200:
    """
    Attributes:
        res (float):  Example: 1.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        product_controller_find_all_by_user_lookback_days_response_200 = cls(
            res=res,
            error=error,
        ...
        product_controller_find_all_by_user_lookback_days_response_200.additional_properties = d
        return product_controller_find_all_by_user_lookback_days_response_200

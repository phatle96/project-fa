...
T = TypeVar("T", bound="DateControllerFindAllByUserResponse200")


@_attrs_define
class DateControllerFindAllByUserResponse200:
    """
    Attributes:
        res (float):  Example: 1.
        ...
        data (Union[Unset, list['DateResponseModel']]):
    """
    ...
    data: Union[Unset, list["DateResponseModel"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = DateResponseModel.from_dict(data_item_data)

            data.append(data_item)

        date_controller_find_all_by_user_response_200 = cls(
            res=res,
            error=error,
        ...
        date_controller_find_all_by_user_response_200.additional_properties = d
        return date_controller_find_all_by_user_response_200

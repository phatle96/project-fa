...
T = TypeVar("T", bound="DateControllerCreateResponse200")


@_attrs_define
class DateControllerCreateResponse200:
    """
    Attributes:
        res (float):  Example: 1.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        date_controller_create_response_200 = cls(
            res=res,
            error=error,
        ...
        date_controller_create_response_200.additional_properties = d
        return date_controller_create_response_200
